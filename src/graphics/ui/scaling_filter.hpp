...
namespace graphics {
    ...
    public:
        ...
        ScalingFilterModel(QObject *parent = nullptr) : QAbstractListModel(parent) {
            ...
            items.push_back(QString::fromStdString(settings::enums::CanonicalizeEnum(current_filter)));
            auto scaling_filter = settings::enums::EnumMetadata<settings::enums::ScalingFilter>::canonicalizations();
    ...
    public slots:
        void onItemSelected(int index) {
            if (index >= 0 && index < items.size()) {
                ...
                auto enum_value = settings::enums::ToEnum<settings::enums::ScalingFilter>(items.at(index).toStdString());
