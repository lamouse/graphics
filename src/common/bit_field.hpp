...
struct BitField {
    ...
    public:
        ...
        static constexpr StorageType mask = (((StorageType)~0) >> (8 * sizeof(T) - bits))
                                            << position;

        /**
         * Formats a value by masking and shifting it according to the field parameters. A value
         * containing several bitfields can be assembled by formatting each of their values and
         * ORing the results together.
         */
        ...
        /**
         * Extracts a value from the passed storage. In most situations prefer use the member
        ...
        [[nodiscard]] constexpr T Value() const { return ExtractValue(storage); }
