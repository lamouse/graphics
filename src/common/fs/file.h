...
class IOFile final {
    public:
        ...
        /**
         * Helper function which deduces the value type of a contiguous STL container used in
         * ReadSpan. If T is not a contiguous container as defined by the concept
         * IsContiguousContainer, this calls ReadObject and T must be a trivially copyable object.
         *
        ...
        /**
         * Helper function which deduces the value type of a contiguous STL container used in
         * WriteSpan. If T is not a contiguous STL container as defined by the concept
         * IsContiguousContainer, this calls WriteObject and T must be a trivially copyable object.
         *
         ...
         * The size of the returned string may not match length if not all bytes are successfully
         * read.
         *
